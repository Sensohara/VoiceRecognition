Telex = ["aas", "aaf", "aar", "aax", "aaj", "aa", "as", "af", "ar", "ax", "aj", "aws", "awf",
                            ...
                            "YJ", "DD"]
Acii = [7845, 7847, 7849, 7851, 7853, 226, 225, 224, 7843, 227, 7841, 7855, 7857, 7859,
...
def convert_telex_to_unicode(telex_str):
    uni = telex_str
    for i in range(133):
        uni = uni.replace(Telex[i], chr(Acii[i]))
        uni = uni.replace("\\","")
    return uni

if __name__ == '__main__':
    uni = convert_telex_to_unicode("mowr cuwra, ddosng cuwra, mowr ddefn, tawst ddefn")
    print(uni)